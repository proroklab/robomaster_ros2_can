...
public:
    ...
    , _rm_led{_can_iostream}
  {
    ...
    emergency_stop_service_ = this->create_service<emergency_stop_msgs::srv::EmergencyStop>("emergency_stop", std::bind(&MinimalSubscriber::emergency_stop_service_callback, this, _1, _2));
  }
